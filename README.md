...
[![Linux Build](https://img.shields.io/travis/PBscoots/Expresso/master.svg?label=build)](https://travis-ci.org/PBscoots/Expresso)

## Project Overview

This was a capstone project where I built all of the routing and database logic for a fake internal tool for a coffee shop called Expresso.
...
If you want to check it out, clone the project, **npm install**, **node server.js** to start the server and then to view your local version of the site, open **index.html** in Google Chrome.

Or you can view all of this functionality in action in the video below:
...
I created the database tables and API routes specified below.
